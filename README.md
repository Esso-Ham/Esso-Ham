...
- 👀 Passionné des nouvelles technologies, initialement technicien informatique, et autodidacte, j'aime apprendre de nouvelles choses et approfondir les sujets que je connais déjà. Je maitrise le **HTML**, **CSS**, **Javascript**, **PHP (+ Laravel)**, **MySQL** & **MariaDB.** En ce moment, je passe ma certification **Python** à mes heures perdues.
